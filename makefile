...
StreamJpegServer: StreamJpegServer.o process_jpeg.o globals.o
	g++ -o StreamJpegServer StreamJpegServer.o process_jpeg.o globals.o `pkg-config opencv --cflags --libs` -lpthread -w

StreamJpegServer.o: StreamJpegServer.cpp
	g++ -Wall -c -o StreamJpegServer.o StreamJpegServer.cpp `pkg-config opencv --cflags --libs` -lpthread -w
